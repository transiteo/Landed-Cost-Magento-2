...
namespace Transiteo\DutiesTaxesCalculator\Setup\Patch\Data;
...
use Transiteo\DutiesTaxesCalculator\Api\Data\DistrictInterfaceFactory;
...
class InstallTransiteoDistrictData implements DataPatchInterface
{
    ...
    {
        $fileName = $this->fixtureManager->getFixture('Transiteo_DutiesTaxesCalculator::fixtures/districts.csv');
