...
{
    /**
     * @param \Magento\Sales\Api\ShipmentItemRepositoryInterface $subject
     * @param \Magento\Sales\Api\Data\ShipmentItemSearchResultInterface $searchResults
     * @return \Magento\Sales\Api\Data\ShipmentItemSearchResultInterface
     */
     public function afterGetList(\Magento\Sales\Api\ShipmentItemRepositoryInterface $subject,\Magento\Sales\Api\Data\ShipmentItemSearchResultInterface $searchResults){
         $entities = [];
    ...
    (
        \Magento\Sales\Api\ShipmentItemRepositoryInterface $subject,
     ...
     */
    public function beforeSave( \Magento\Sales\Api\ShipmentItemRepositoryInterface $subject, \Magento\Sales\Api\Data\ShipmentItemInterface $entity){
        $extensionAttributes = $entity->getExtensionAttributes();
